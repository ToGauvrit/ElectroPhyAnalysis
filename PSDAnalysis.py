...
def psd_bands(psd, bands, freqs):
    ...
    for band in bands.keys():
        ...
        psd_per_bands[band].append(power)
    return psd_per_bands

#TODO
# def computation_psd_bands(psd_dataframe_group1,psd_dataframe_group2,group1_name, group2_name, output_filename):
